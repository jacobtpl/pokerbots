...
class Player(Bot):
    ...
    def calc_strength(self, hole, iters, board, weighted = True):
        ''' 
    ...
    # def preflop(self, game_state, round_state, active):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        # if street == 0 and my_pip <= BIG_BLIND:
        #     return self.preflop(game_state, round_state, active)
